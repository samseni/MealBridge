...
router.get('/all', authMiddleware, roleMiddleware(['ngo', 'admin']), listingsController.getAllListings);
router.get('/nearby', authMiddleware, roleMiddleware(['ngo', 'admin']), listingsController.getNearbyListings);
